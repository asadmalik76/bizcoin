...
<h2 class="brand-text mb-0">Bizcoin</h2>
</a></li>
...
<li class=" nav-item"><a href="/admin/dashboard"><i class="feather icon-home"></i><span class="menu-title" data-i18n="users">Dashboard</span></a>
</li>

<li class=" nav-item"><a href="/admin/users"><i class="feather icon-user-plus"></i><span class="menu-title" data-i18n="users">Manage Users</span></a>
</li>

<li class=" nav-item"><a href="/admin/usersbalance/"><i class="feather icon-user-plus"></i><span class="menu-title" data-i18n="users">Manage Balance</span></a>
</li>
<li class=" nav-item"><a href="/admin/pricing"><i class="feather icon-users"></i><span class="menu-title" data-i18n="users">Manage Pricing</span></a>
</li>

<li class=" nav-item"><a href="/admin/returnrate"><i class="feather icon-dollar-sign"></i><span class="menu-title" data-i18n="users">Manage Return Rate</span></a></li>
</li>
<li class=" nav-item"><a href="/admin/withdraws"><i class="feather icon-dollar-sign"></i><span class="menu-title" data-i18n="users">Manage Withdraws</span></a></li>
</li>
<li class=" nav-item"><a href="#"><i class="feather icon-zap"></i><span class="menu-title" data-i18n="Starter kit">Manage Pages</span></a>
    <ul class="menu-content">
        <li><a href="/admin/termspage"><i></i><span class="menu-item" data-i18n="2 columns">Terms and services</span></a>
        </li>
        <li class=""><a href="/admin/privacypage"><i></i><span class="menu-item" data-i18n="Fixed navbar">Privacy Policy</span></a>
        </li>
        </li>
    </ul>
</li>

<li class=" nav-item"><a href="/admin/testimonials"><i class="feather icon-dollar-sign"></i><span class="menu-title" data-i18n="users">Manage Testimonials</span></a></li>
</li>
<li class=" nav-item"><a href="/admin/contacts"><i class="feather icon-dollar-sign"></i><span class="menu-title" data-i18n="users">Manage Contacts</span></a></li>
</li>

<li class=" nav-item"><a href="#"><i class="feather icon-dollar-sign"></i><span class="menu-title" data-i18n="users">Manage Messages</span></a></li>
</li>
<!-- 
